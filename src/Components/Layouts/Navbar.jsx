...
const Navbar = () => {
  ...
  return (
    <section className='' >
    <nav ref={navref} className='nav fixed z-50 flex flex-row w-screen md:rounded-full gap-20 justify-center md:flex-row md:gap-20  items-center  md:justify-center py-4 px-6 h-20 bg-green-900' >
         <div >
