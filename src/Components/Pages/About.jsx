    ...
    <section className='w-full md:h-screen bg-green-900 md:p-20 p-10 mt-15 '>
        <div className='md:flex flex-col md:flex-row w-full h-full justify-center items-center'>
          ...
          <div className="flex-1 text-white flex flex-col items-center md:items-left w-full h-full justify-center">
            ...
            <p className='w-70 md:text-lg text-sm text-center md:text-left  mb-10 md:w-140'>Amandeep Rawat is a passionate full-stack web developer focused on building modern, responsive, and real-time web applications using React and the MERN stack. I enjoy creating clean and interactive user interfaces, and I have hands-on experience developing features like real-time chat systems, API integrations, and dynamic dashboards. I aim to deliver efficient, scalable, and user-friendly solutions while continuously improving my skills and staying updated with the latest web technologies.</p>
            <div className="">
